...
P.S. Жаль, что я не смог выполнить ДЗ по темам, где нужен был terraform. Я долго возился с настройкой VPN, но это не помогло, и тогда я сделал свой сервер, что тоже не помогло потому что хаши корп заблокировали зеркало яндекса
А настройку VPN-сервера за выполненную работу не зачтут
